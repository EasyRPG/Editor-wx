...
char * Player::get_skill_name(int num)
{
...
char * Player_Team::get_name(int num)
{
   return (((Players.at(num))).get_name()); 
}
char * Player_Team::get_job(int num)
{
...
char * Player_Team::get_item_name(int num)
{
...
char * Player_Team::get_skill_name(int nump,int num)
{  
