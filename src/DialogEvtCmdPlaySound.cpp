    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER)
{
    ...
    const wxString listSound_choices[] = {
        _("<set by wxGlade>"),
    };
    listSound = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 1, listSound_choices, wxLB_SINGLE);
...
void DialogEvtCmdPlaySound::do_layout()
{
    ...
    szPlaySound->Add(szBottom, 0, wxALIGN_RIGHT|wxBOTTOM|wxRIGHT, 3);
