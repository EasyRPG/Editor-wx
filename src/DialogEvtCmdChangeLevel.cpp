...
void DialogEvtCmdChangeLevel::do_layout()
{
    ...
    szLevel->Add(szTarget, 0, wxEXPAND|wxLEFT|wxRIGHT, 1);
    szLevel->Add(rbOperation, 0, wxEXPAND|wxLEFT|wxRIGHT, 1);
    ...
    szLevel->Add(szOperand, 0, wxEXPAND|wxLEFT|wxRIGHT, 1);
    szOptions->Add(chbShowMessage, 1, 0, 0);
    szLevel->Add(szOptions, 0, wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT, 1);
    ...
    szLevel->Add(szBottom, 1, wxALIGN_RIGHT|wxBOTTOM|wxRIGHT, 3);
    SetSizer(szLevel);
    szLevel->Fit(this);
    Layout();
    // end wxGlade
