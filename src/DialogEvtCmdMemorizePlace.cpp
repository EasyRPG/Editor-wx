    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER)
{
    ...
    szVariable_staticbox = new wxStaticBox(this, wxID_ANY, _("Store in variable"));
...
void DialogEvtCmdMemorizePlace::do_layout()
{
    ...
    szMemorizePlace->Add(szVariable, 0, wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT, 1);
    ...
    szMemorizePlace->Add(szBottom, 1, wxALIGN_RIGHT|wxBOTTOM|wxRIGHT, 3);
