...
void DialogEvtCmdGetPositionID::do_layout()
{
    ...
    szGetPositionID->Add(szPlace, 0, wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT, 1);
    ...
    szGetPositionID->Add(szStoreVariableID, 0, wxEXPAND|wxLEFT|wxRIGHT, 1);
    ...
    szGetPositionID->Add(szBottom, 1, wxALIGN_RIGHT|wxBOTTOM|wxRIGHT, 3);
