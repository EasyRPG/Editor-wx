...
//int intCondeffects;// =0x48, //array de un byte
std::vector<char> vc_ch_Condeffects;
int intAttriblength;// =0x49,
//int intAttribeffects;// =0x4A //array de un byte
...
stcSound_effect Title_music;//0x1F,
stcSound_effect Battle_music;//0x20,
stcSound_effect Battle_end_music;//0x21,
stcSound_effect Inn_music;//0x22,
stcSound_effect Skiff_music;//0x23,
stcSound_effect Boat_music;//0x24,
stcSound_effect Airship_music;//0x25,
stcSound_effect Game_Over_music;//0x26,
...
{      
  ...
  //Animated_battle_Combat_Anime		=0x0A, //two diminsional arrays 
  //Animated_battle_Anime_combat_weapons=0x0B //two diminsional arrays 
